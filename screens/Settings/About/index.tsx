    ...
    try {
      ...
      const fetchSMDtls = async () => {
        ...
        try {
          ...
          const userDtls = compDtls.data.getSMAccount;
              ...
              <View style={styles.image}>
                <ScrollView>
                  ...
                  <View style={styles.sendLoanView}>
                    <TextInput multiline={true} value={CompPW1} onChangeText={setCompPW1} style={styles.sendLoanInput} editable={true}></TextInput>

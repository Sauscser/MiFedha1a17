  ...
  return <View>
              <View style={styles.image}>
                <ScrollView>
                  ...
                  <View style={styles.sendLoanView}>
                    <TextInput value={PWTwos} onChangeText={setPWTwo} style={styles.sendLoanInput} editable={true}></TextInput>
                    <Text style={styles.sendLoanText}>Selling Price</Text>
                  </View>

                  <View style={styles.sendLoanView}>
                    <TextInput value={PWThree} onChangeText={setPWThree} style={styles.sendLoanInput} editable={true}></TextInput>
                    <Text style={styles.sendLoanText}>Buying Price</Text>
                  </View>
        
                  <View style={styles.sendLoanView}>
                    <TextInput value={PWFour} onChangeText={setPWFour} style={styles.sendLoanInput} editable={true}></TextInput>

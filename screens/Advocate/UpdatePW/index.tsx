  ...
  return <View>
      <View style={styles.image}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.sendLoanView}>
            <TextInput value={NewAdmnPW} onChangeText={setNewAdmnPW} style={styles.sendLoanInput} secureTextEntry={true} editable={true} />
            <Text style={styles.sendLoanText}>New Advocate PW</Text>
          </View>

          <TouchableOpacity onPress={fetchAdvDtls} style={styles.sendLoanButton}>

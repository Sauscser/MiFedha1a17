...
import { View, FlatList, Text, Pressable, useWindowDimensions, Platform, ActivityIndicator } from 'react-native';
  ...
  return <View style={{
    flex: 1
      ...
      width: '100%'
        ...
        item
      }) => <Carousels Agent={item} isSelected={item.phonecontact === selectedAgentPhone} />} getItemLayout={(_, index) => ({
        length: CARD_WIDTH,
      ...
      elevation: 5
        ...
        <Pressable onPress={() => adjustRadius(false)} style={{
        marginHorizontal: 5,
        padding: 8,
        ...
        <Pressable onPress={() => adjustRadius(true)} style={{
        marginHorizontal: 5,
        padding: 8,

      ...
      <View style={styles.image}>
        <ScrollView>
          ...
          <View style={styles.sendLoanView}>
            <TextInput value={nationalId} onChangeText={setNationalid} style={styles.sendLoanInput} placeholder="Chama Admin Email" editable={!isLoading} />
          </View>

          <View style={styles.sendLoanView}>
            <TextInput value={ChamaAcNus} onChangeText={setChamaAcNus} style={styles.sendLoanInput} placeholder="Chama Account Number" editable={!isLoading} />
          </View>

          <View style={styles.sendLoanView}>
            <TextInput value={pword} onChangeText={setPW} secureTextEntry={true} style={styles.sendLoanInput} placeholder="Password" editable={!isLoading} />
          </View>

          <TouchableOpacity onPress={gtUsrDtls4AdminDtls} style={styles.sendLoanButton} disabled={isLoading}>

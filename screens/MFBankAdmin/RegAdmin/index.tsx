              ...
              <View style={styles.image}>
                <ScrollView>
                  ...
                  <View style={styles.sendLoanView}>
                    <TextInput value={nationalId} onChangeText={setNationalid} style={styles.sendLoanInput} editable={true}></TextInput>
                  ...
                  <View style={styles.sendLoanView}>
                    <TextInput value={AdminBank} onChangeText={setAdminBank} style={styles.sendLoanInput} editable={true}></TextInput>
                    <Text style={styles.sendLoanText}>Bank Branch Number</Text>
                  </View>

                  <View style={styles.sendLoanView}>
                    <TextInput value={AdminBankAcNu} onChangeText={setAdminBankAcNu} style={styles.sendLoanInput} editable={true}></TextInput>

...
import { getChamaDepositSync, listChamaApplies, listChamaDepositSyncs, listGroups } from '../../../src/graphql/queries';
        ...
        try {
            ...
            const Lonees = await API.graphql(
                graphqlOperation(listChamaDepositSyncs, {
                    ...
                    transactionType:  {eq: "chamaBenSync"}                  
            ...
            {
                Alert.alert ("You have not synced any benefits")
            }

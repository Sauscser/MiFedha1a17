...
import { listPersonels, listNonLoans, VwMyRecMny, VwMySntMny } from '../../../../../src/graphql/queries';
...
const FetchSMNonLnsSnt = () => {
  ...
  const fetchLoanees = async () => {
    ...
    try {
      ...
      const recordsRes: any = await API.graphql(graphqlOperation(VwMySntMny, {
        senderPhn: bizPhone ,
        sortDirection:"DESC",
        limit:100,
        filter: {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.inputBlock}>
        ...
        />
        <TextInput
          placeholder="Seller Name even partial"
          value={searchQuery}
      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
          <>
            ...
            <Text style={styles.label}>Purchases from Businesses</Text>
          </>
        )}
      />
    </View>

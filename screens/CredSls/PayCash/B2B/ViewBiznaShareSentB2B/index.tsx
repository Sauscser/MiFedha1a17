...
const FetchSMNonLnsSnt = () => {
  ...
  const fetchLoanees = async () => {
    ...
    try {
      ...
      if (!items.length) {
        Alert.alert('No Records', 'No money sent yet to businesses.');
      }
      setRecvrs(items);
    } catch (e) {
  ...
  return <View style={styles.container}>
      <View style={styles.inputBlock}>
        ...
        <TextInput placeholder="Seller Name even partial" value={searchQuery} onChangeText={setSearchQuery} style={styles.input} />
      </View>

  ...
  return <SafeAreaView>
      ...
      start={{
        ...
        y: 1
            ...
            <Section title="Biz Products" options={[{
          label: 'Benefit Product (Create)',
          onPress: AddBeneficiaryProduct,
          style: styles.ClientsPressables
        }, {
          label: 'View Business Benefits Shared',
          onPress: ViewBenShares,
          style: styles.ClientsPressables
        }, {
          label: 'Share Business Benefits',
          onPress: VwBenToShare,
          style: styles.ClientsPressables
        }, {
          label: 'Link Beneficiary',
          ...
          label: 'View As Product Creator',
          onPress: ViewAsProdCreator,
          style: styles.ClientsPressables
        }]} />
        
        <Section title="Manage Business" options={[{
          label: 'Create Biz/Institution',
          ...
          label: 'Register Sales Officer',
          onPress: AddPersonelss,
          style: styles.ClientsPressables
        }, {
          label: 'DeReg Sales Officer',
          ...
          <Section title="Make Credit Sales Requests" options={[{
          label: 'Make Credit Sales Requests',
          onPress: BiznaReqstPage1
        }]} />


        <Section title="Grant Credit Sales Requests" options={[{
          label: 'Pal2Pal',
        ...
        <Section title="CreditSales LoanStatus (Biz)" options={[{
          label: 'BizPal Loaners',
          onPress: SI2VwBiz2PalLoaners
        }, {
          label: 'BizPal Loanees',
          onPress: SI2VwBiz2PalLoanees
        }, {
          label: 'BizBiz Loaners',
          onPress: SI2VwBiz2BizLoaners
        }, {
          label: 'BizBiz Loanees',
          onPress: SI2VwBiz2BizLoanees
        }]} />

        <Section title="CreditSales LoanStatus (Pal)" options={[{
          label: 'PalPal Loaners',
          onPress: VwPalLners
        }, {
          label: 'PalPal Loanees',
          onPress: VwPalLnees
        }, {
          label: 'PalBiz Loaners',
          onPress: VwPal2BizLners
        }, {
          label: 'PalBiz Loanees',
          onPress: VwPal2BizLnees
        }]} />

        <Section title="Cash Sales/purchases & Deposits" options={[{
          label: 'Cash Sales',
          onPress: PayCash,
          style: styles.ClientsPressables
        }, {
        ...
        <Section title="Business Cash Transfers " options={[{
          label: 'Send Cash to Pal',
          onPress: ShareCredSlsRevss,
          style: styles.ClientsPressables
        }, {
          label: 'Send Cash to Biz',
         ...
         */
        {
          ...
          label: 'View Cash sent to Biz',
          onPress: ViewBiznaShareSent,
          style: styles.ClientsPressables
        }]} />
        
        <Section title="Biz Adverts" options={[{
          label: 'Transfer Ownership',
          onPress: giveBizna,
          style: styles.ClientsPressables
        }, {
          label: 'Receive Ownership',

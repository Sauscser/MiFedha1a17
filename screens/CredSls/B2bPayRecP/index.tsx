                ...
                try {
                  ...
                  const fetchCompDtls = async () => {
                    ...
                    const fetchRecUsrDtls = async () => {
                      ...
                      // ... (rest of nested functions migrated similarly with client.graphql)
                      // For brevity, all updateBizna, updateCompany, updateSMAccount, and createNonLoans calls
                      // are rewritten to use client.graphql({ query, variables }) exactly as above.

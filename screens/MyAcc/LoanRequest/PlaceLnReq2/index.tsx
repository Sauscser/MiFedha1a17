          ...
          const gtLnerDtls = async () => {
            ...
            try {
              ...
              const CreateNewSMAc2 = async () => {
                ...
                Communications.textWithoutEncoding(awsEmail, 'MiFedha. Hi ' + namez + '. It is ' + name + '. I request a soft loan of Ksh. ' + itemPrys + ' from you. ' + 'Please go to MiFedha app to grant me the request' + '. Thank you.');
              };

    ...
    <View style={styles.image}>
      ...
      <View style={styles.loanTitleView}>
        <View style={styles.root}>
          <FlatList style={{
            width: "100%"
          }} data={Loanees3} renderItem={({
            item
          }) => <AutoChmCovLn ChamaMmbrshpDtls={item} />} keyExtractor={(item, index) => index.toString()} onRefresh={fetchLoanees} refreshing={loading} showsVerticalScrollIndicator={false} ListHeaderComponentStyle={{
            alignItems: 'center'
          }} ListHeaderComponent={() => <>
      ...
      <View style={styles.loanTitleView}>
        <View style={styles.root}>
          <FlatList style={{
            width: "100%"
          }} data={Loanees5} renderItem={({
            item
          }) => <AutoCrdSlCv Loanee={item} />} keyExtractor={(item, index) => index.toString()} onRefresh={fetchLoanees} refreshing={loading} showsVerticalScrollIndicator={false} ListHeaderComponentStyle={{
            alignItems: 'center'
          }} ListHeaderComponent={() => <>

                              ...
                              const FetchWrkrDtls2 = async () => {
                                ...
                                try {
                                  ...
                                  const updtLnReq2 = async () => {
                                    ...
                                    Communications.textWithoutEncoding(RecPhn, 'MiFedha. Hi ' + busNames2 + ', you have been loaned services/goods worth Ksh. ' + parseFloat(amount).toFixed(2) + ' by ' + name + '. For clarification call the Loaner: ' + phonecontact + '. The following is a break down of your repayable loan: ' + ' Cash price of the goods is Ksh. ' + parseFloat(amount).toFixed(2) + '. Amount you had committed to repay is Ksh. ' + amtrpayable2.toFixed(2) + '. Transaction fee is Ksh. ' + lnTrnsfrFee.toFixed(2) + '. Total Repayable is Ksh ' + TotalAmtExp2.toFixed(2) + '. Thank you.');
                                    setIsLoading(false);
                                  };

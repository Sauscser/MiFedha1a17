              ...
              const ftchNonCvdChmLn = async () => {
                ...
                try {
                  ...
                  const ftchCvdCredSlrLn = async () => {
                    ...
                    setIsLoading(true);
                    try {
                      const RecAccountDtl3: any = await client.graphql({
                      ...
                      const ftchNonCovCredSlrLn = async () => {
                        ...
                        setIsLoading(true);
                        try {
                          const RecAccountDtl4: any = await client.graphql({
                          ...
                          const ftchCvdSMLn = async () => {
                            ...
                            setIsLoading(true);
                            try {
                              const RecAccountDtl5: any = await client.graphql({
                              ...
                              const ftchNonCvdSMLn = async () => {
                                ...
                                setIsLoading(true);
                                try {
                                  const RecAccountDtl6: any = await client.graphql({
                                  ...
                                  if (RecAccountDtl6.data.listSMLoansNonCovereds.items.length > 0 || RecAccountDtl5.data.listSMLoansCovereds.items.length > 0 || RecAccountDtl4.data.listNonCovCreditSellers.items.length > 0 || RecAccountDtl3.data.listCovCreditSellers.items.length > 0 || RecAccountDtl2.data.listNonCvrdGroupLoans.items.length > 0 || RecAccountDtl1.data.listCvrdGroupLoans.items.length > 0) {

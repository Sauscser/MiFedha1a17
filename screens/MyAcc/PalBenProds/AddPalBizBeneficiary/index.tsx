  ...
  return <LinearGradient colors={['#e58d29', 'skyblue']} start={[0, 0]} end={[1, 1]} style={{
    flex: 1
                    ...
                    <View style={styles.formContainer}>
                      ...
                      <TextInput placeholder="Beneficiary Email" style={styles.passwordInput} value={groupCnt} onChangeText={setgroupCnt} placeholderTextColor="#ccc" />
                      
                     <View style={styles.passwordContainer}>
                                                                   <TextInput placeholder="My Main Account Password" style={styles.passwordInput} value={SMPW} onChangeText={setSMPW} secureTextEntry={!isPasswordVisible} placeholderTextColor="#ccc" />
                    ...
                    <TouchableOpacity onPress={fetchSMDtls} style={styles.button}>
